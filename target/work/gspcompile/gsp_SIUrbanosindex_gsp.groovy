...
class gsp_SIUrbanosindex_gsp extends GroovyPage {
...
createTagBody(1, {->
printHtmlPart(1)
invokeTag('captureMeta','sitemesh',4,['gsp_sm_xmlClosingForEmptyTag':("/"),'name':("layout"),'content':("login_bar")],-1)
printHtmlPart(1)
createTagBody(2, {->
...
public static final long LAST_MODIFIED = 1424983833577L
